...
const DetailModalAntenne= ({ isOpenModalInfo, onCloseModalInfo, antenne}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{antenne.marque}</p>
          <p><span className="font-semibold">Modele : </span>{antenne.modele}</p>
          <p><span className="font-semibold">Numero de série : </span>{antenne.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{antenne.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{antenne.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{antenne.userActuel.prenom} {antenne.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{antenne.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{antenne.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {antenne.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {antenne.historique.map((element, index) => (
...
export default DetailModalAntenne;
