...
const DetailModalRouteur = ({ isOpenModalInfo, onCloseModalInfo, routeur}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{routeur.marque}</p>
          <p><span className="font-semibold">Modele : </span>{routeur.modele}</p>
          <p><span className="font-semibold">Nombre de port : </span>{routeur.nbrePort}</p>
          <p><span className="font-semibold">POE : </span>{routeur.poe}</p>
          <p><span className="font-semibold">Vitesse : </span>{routeur.vitesse}</p>
          <p><span className="font-semibold">Numero de série : </span>{routeur.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{routeur.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{routeur.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{routeur.userActuel.prenom} {routeur.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{routeur.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{routeur.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {routeur.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {routeur.historique.map((element, index) => (
...
export default DetailModalRouteur;
