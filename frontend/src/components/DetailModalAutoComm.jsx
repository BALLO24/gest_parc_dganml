...
const DetailModalAutoComm = ({ isOpenModalInfo, onCloseModalInfo, autoComm}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{autoComm.marque}</p>
          <p><span className="font-semibold">Modele : </span>{autoComm.modele}</p>
          <p><span className="font-semibold">Nombre de port : </span>{autoComm.nbrePort}</p>
          <p><span className="font-semibold">Numero de série : </span>{autoComm.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{autoComm.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{autoComm.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{autoComm.userActuel.prenom} {autoComm.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{autoComm.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{autoComm.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {autoComm.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {autoComm.historique.map((element, index) => (
...
export default DetailModalAutoComm;
