...
const NouvelPareFeu = ({
  isOpenFormNouvelPareFeu,
  closeFormNouvelPareFeu,
  onSuccess,
}) => {
  ...
  if (!isOpenFormNouvelPareFeu) return null;
    ...
    >
      ...
      >
        <h3 className="text-lg font-semibold text-gray-700 mb-4">
          Ajouter un nouvel Pare Feu
        </h3>

        {/* Bouton fermer */}
        <button
          type="button"
          onClick={closeFormNouvelPareFeu}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="pareFeu" />
