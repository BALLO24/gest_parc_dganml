...
const DetailModalImprimante = ({ isOpenModalInfo, onCloseModalInfo, imprimante}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Type : </span>{imprimante.typeImprimante}</p>
          <p><span className="font-semibold">Marque : </span>{imprimante.marque}</p>
          <p><span className="font-semibold">Modele : </span>{imprimante.modele}</p>
          <p><span className="font-semibold">Bac : </span>{imprimante.typeBac}</p>
          <p><span className="font-semibold">Recto verso : </span>{imprimante.rectoVerso}</p>
          <p><span className="font-semibold">Couleur : </span>{imprimante.couleur}</p>
          <p><span className="font-semibold">Numero de série : </span>{imprimante.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{imprimante.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{imprimante.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{imprimante.userActuel.prenom} {imprimante.userActuel.nom}</p>
          <p><span className="font-semibold">Utilisateur site : </span>{imprimante.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{imprimante.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {imprimante.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {imprimante.historique.map((element, index) => (
...
export default DetailModalImprimante;
