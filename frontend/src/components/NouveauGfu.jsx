...
const NouveauGfu = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await API.addNumGfu(finalData);
      onSuccess("Numéro GFU ajouté avec succès !");
  ...
  if (!isOpenFormNouveauGfu) return null;
    ...
    >
      ...
      >
        <h3 className="text-lg font-semibold text-gray-700 mb-4">
          Ajouter un numero GFU
        </h3>

        {/* Bouton fermer */}
        <button
          type="button"
          onClick={closeFormNouveauGfu}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FloatingInput label="Numéro" name="numero" required />
