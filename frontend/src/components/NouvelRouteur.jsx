...
const NouvelRouteur = ({
  isOpenFormNouvelRouteur,
  closeFormNouvelRouteur,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Routeur ajouté avec succès !");
  ...
  if (!isOpenFormNouvelRouteur) return null;
    ...
    >
      ...
      >
        <h3 className="text-lg font-semibold text-gray-700 mb-4">
          Ajouter un nouvel Routeur
        </h3>

        {/* Bouton fermer */}
        <button
          type="button"
          onClick={closeFormNouvelRouteur}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="routeur" />
          ...
          <FloatingInput label="Vitesse" name="vitesse" required />
          ...
          <FloatingSelect label="POE" name="poe" required>
            <option value="">---</option>
