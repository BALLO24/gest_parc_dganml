...
const NouvelControleur = ({
  isOpenFormNouvelControleur,
  closeFormNouvelControleur,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Controleur ajouté avec succès !");
  ...
  if (!isOpenFormNouvelControleur) return null;
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={closeFormNouvelControleur}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="controleur" />
...
export default NouvelControleur;
