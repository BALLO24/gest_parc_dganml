...
const NouvelNAS = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("NAS ajouté avec succès !");
  ...
  if (!isOpenFormNouvelNAS) return null;
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="NAS" />
          ...
          <FloatingInput type="number" label="Nombre de slots de disque" name="nbreSlotDisque" required />
