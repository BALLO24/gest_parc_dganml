...
const NouvelCopieur = ({
  isOpenFormNouvelCopieur,
  closeFormNouvelCopieur,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Copieur ajouté avec succès !");
  ...
  if (!isOpenFormNouvelCopieur) return null;
    ...
    >
      ...
      >
        <h3 className="text-lg font-semibold text-gray-700 mb-4">
          Ajouter un nouveau copieur
        </h3>

        {/* Bouton fermer */}
        <button
          type="button"
          onClick={closeFormNouvelCopieur}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="copieur" />
