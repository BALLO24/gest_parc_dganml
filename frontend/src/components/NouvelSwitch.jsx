...
const NouvelSwitch = ({
  isOpenFormNouvelSwitch,
  closeFormNouvelSwitch,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Switch ajouté avec succès !");
  ...
  if (!isOpenFormNouvelSwitch) return null;
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FloatingSelect label="Manageable" name="manageable" required>
            <option value="">---</option>
            <option value="oui">Oui</option>
            <option value="non">Non</option>
          </FloatingSelect>
