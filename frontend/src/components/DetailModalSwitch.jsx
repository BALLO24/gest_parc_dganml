...
const DetailModalSwitch = ({ isOpenModalInfo, onCloseModalInfo, switchs}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{switchs.marque}</p>
          <p><span className="font-semibold">Modele : </span>{switchs.modele}</p>
          <p><span className="font-semibold">Nombre de port : </span>{switchs.nbrePort}</p>
          <p><span className="font-semibold">POE : </span>{switchs.poe}</p>
          <p><span className="font-semibold">Manageable : </span>{switchs.manageable}</p>
          <p><span className="font-semibold">Numero de série : </span>{switchs.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{switchs.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{switchs.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{switchs.userActuel.prenom} {switchs.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{switchs.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{switchs.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {switchs.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {switchs.historique.map((element, index) => (
...
export default DetailModalSwitch;
