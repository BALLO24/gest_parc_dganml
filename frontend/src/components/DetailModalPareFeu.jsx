...
const DetailModalPareFeu = ({ isOpenModalInfo, onCloseModalInfo, pareFeu}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{pareFeu.marque}</p>
          <p><span className="font-semibold">Modele : </span>{pareFeu.modele}</p>
          <p><span className="font-semibold">Nombre de port : </span>{pareFeu.nbrePort}</p>
          <p><span className="font-semibold">Numero de série : </span>{pareFeu.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{pareFeu.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{pareFeu.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{pareFeu.userActuel.prenom} {pareFeu.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{pareFeu.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{pareFeu.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {pareFeu.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {pareFeu.historique.map((element, index) => (
...
export default DetailModalPareFeu;
