...
const NouvelProjecteur = ({
  isOpenFormNouvelProjecteur,
  closeFormNouvelProjecteur,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Projecteur ajouté avec succès !");
  ...
  if (!isOpenFormNouvelProjecteur) return null;
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={closeFormNouvelProjecteur}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="projecteur" />
...
export default NouvelProjecteur;
