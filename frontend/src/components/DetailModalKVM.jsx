...
const DetailModalKVM= ({ isOpenModalInfo, onCloseModalInfo, kvm}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{kvm.marque}</p>
          <p><span className="font-semibold">Modele : </span>{kvm.modele}</p>
          <p><span className="font-semibold">Numero de série : </span>{kvm.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{kvm.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{kvm.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{kvm.userActuel.prenom} {kvm.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{kvm.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{kvm.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {kvm.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {kvm.historique.map((element, index) => (
