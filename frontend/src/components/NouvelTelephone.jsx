...
const NouvelTelephone = ({
  isOpenFormNouvelTelephone,
  closeFormNouvelTelephone,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Téléphone ajouté avec succès !");
  ...
  if (!isOpenFormNouvelTelephone) return null;
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={closeFormNouvelTelephone}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FloatingSelect label="Interface graphique" name="intGraphique" required>
            <option value="">---</option>
...
export default NouvelTelephone;
