...
const NouvelAntenne = ({
  isOpenFormNouvelAntenne,
  closeFormNouvelAntenne,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess("Antenne ajouté avec succès !");
  ...
  if (!isOpenFormNouvelAntenne) return null;
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={closeFormNouvelAntenne}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input type="hidden" name="type" value="antenne" />
          ...
          <FloatingInput type="number" label="Diamètre (cm)" name="diametre" required />
