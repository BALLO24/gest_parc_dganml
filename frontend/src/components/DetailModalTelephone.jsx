...
const DetailModalTelephone = ({ isOpenModalInfo, onCloseModalInfo, telephone}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{telephone.marque}</p>
          <p><span className="font-semibold">Modele : </span>{telephone.modele}</p>
          <p><span className="font-semibold">Interface graphique : </span>{telephone.intGraphique}</p>
          <p><span className="font-semibold">Numero de série : </span>{telephone.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{telephone.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{telephone.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{telephone.userActuel.prenom} {telephone.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{telephone.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{telephone.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {telephone.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {telephone.historique.map((element, index) => (
...
export default DetailModalTelephone;
