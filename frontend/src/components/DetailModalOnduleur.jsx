...
const DetailModalOnduleur = ({ isOpenModalInfo, onCloseModalInfo, onduleur}) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 text-gray-700 text-sm">
          <p><span className="font-semibold">Marque : </span>{onduleur.marque}</p>
          <p><span className="font-semibold">Modele : </span>{onduleur.modele}</p>
          <p><span className="font-semibold">Type Onduleur : </span>{onduleur.typeOnduleur}</p>
          <p><span className="font-semibold">Puissance : </span>{onduleur.puissance}</p>
          <p><span className="font-semibold">Numero de série : </span>{onduleur.noSerie}</p>
          <p><span className="font-semibold">Date d'acquisition : </span>{onduleur.dateAchat}</p>
          <p><span className="font-semibold">Etat : </span>{onduleur.etat}</p>
          <p><span className="font-semibold">Utilisateur actuel : </span>{onduleur.userActuel.prenom} {onduleur.userActuel.nom}</p>
          <p><span className="font-semibold">Site actuel : </span>{onduleur.userActuel.site.nom}</p>
          <p><span className="font-semibold">Autres infos : </span>{onduleur.commentaire}</p>
          <div className="mt-4">
            <span className="font-semibold">Historique :</span>
            {onduleur.historique.length !== 0 ? (
              <table className="min-w-full mt-2 text-sm border border-gray-200 rounded-lg overflow-hidden">
                ...
                <tbody>
                  {onduleur.historique.map((element, index) => (
...
export default DetailModalOnduleur;
