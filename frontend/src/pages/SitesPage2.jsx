...
import NouveauLieu from "../components/NouveauSite";
import SearchBar from "../components/SearchBar";
import { AiFillDelete } from "react-icons/ai";
import ConfirmSuppression from "../components/CofirmSuppression";
import API from "../services/API";
// import DetailModalLieu from "../components/DetailModalLieu";
// import DropdownAjoutLieu from "../components/DropDownAjoutLieu";
...
export default function SitesPage(){
      ...
      useEffect(() => {
        ...
        useEffect(()=>{
            ...
            const [isOpenFormNouveauLieu,setIsOpenFormNouveauLieu]=useState(false);
            const [isOpenModalSuppr,setIsOpenModalSuppr]=useState(false)
            
            
            const handleClose=()=>{
                setIsOpenFormNouveauLieu(false)
            }


            const openFormNouveauLieu=()=>{
                setIsOpenFormNouveauLieu(true)
            }
        ...
        <>
           <div className="relative ml-52 p-4 max-w-full overflow-hidden ">
                ...
                <SearchBar 
                    ...
                    className=""
                />
                <button onClick={()=>openFormNouveauLieu()} className="px-2 py-2 absolute right-10 top-4 font-bold rounded-sm bg-gradient-to-r from-green-400 via-green-500 to-green-700 text-white shadow hover:opacity-90">+ Ajouter</button>
                {/* Desktop-Version */}
                ...
                <NouveauLieu isOpenFormNouveauLieu={isOpenFormNouveauLieu} closeFormNouveauLieu={handleClose}/>
